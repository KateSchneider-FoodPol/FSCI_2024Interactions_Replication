---
title: "FSCI Interactions Literature Search"
author: "FSCI Team"
...
### *Overall Objectives*
Automated literature search of the pairs of indicators where a direct relationship was identified in the expert elicitation.
...
# Load packages
    ...
    # to install dimensionsR, addition commands are needed 
    # they are commented-out to prevent re-installing :
...
# Set relative directory paths
    data_in <- file.path(".", "Interactions_LitSearch", "Input Data")
    fig_out <- file.path(".", "Interactions_LitSearch", "Figures")
    lit_out <- file.path(".", "Interactions_LitSearch", "Literature")
...
search_terms <- readxl::read_excel("Input Data/Concepts terms revised_2024.xlsx")
...
# export results 
openxlsx::write.xlsx(search_terms_df_1, "search terms_result_7.xlsx")
...
result_df <- result_df %>% dplyr::filter(cld2 == "en" & cld3 == "en") # removed 1141 non english articles 
...
```{r}
# merge in indicator 
search_terms_df_1 <- readxl::read_excel("search terms_result_7.xlsx")
...
# save results
openxlsx::write.xlsx(search_terms_df_1, "search terms_result_8.xlsx")
```
