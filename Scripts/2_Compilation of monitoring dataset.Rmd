...
### Euromonitor retail value of ultraprocessed foods
      # To acces input data, visit https://www.foodsystemsdashboard.org/indicators/food-environments/product-properties/retail-value-of-ultra-processed-food-sales-per-capita/table and select Table view. Copy these data yourself into a file. Data should have columns: Country	2017	2018	2019	2020	2021 and be saved in an excel workbook titled "UPFretailval.xlsx" saved in the subfolder "Input Datasets" for the following code to work.
