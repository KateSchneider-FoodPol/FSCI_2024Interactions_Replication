...
```{r, warning = FALSE, messages = FALSE, cache = TRUE}
  ...
  tmap_save(map, file.path(figtab_out, "Figure 2.pdf"), width = 10, height = 3.5, dpi=300, units = "in")
...
# Regress each variable on time to get average linear trend
  ...
  # Get the sample size (countries by years) per indicator
    ...
    # Name the columns nicely
    col_names <- c( "Indicator", "Coef.", "SE", "p val.", "merge1", "95% Conf. Int.", "merge2", "Desirable direction", "N Countries", "Years", "merge3", "N years")
    colnames(regress_tbl) <- col_names
...
# plot it
  png(file.path(figtab_out, "SI Figure 24.png"), width = 10, height = 8.5, unit = "in", res = 300)
